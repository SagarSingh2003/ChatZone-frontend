...
export default function MoreOptions({ x , y , messageid , setShowMoreOptions , setRefreshServerAndRoomData}){
              ...
              <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                  ...
                  <div class="p-4 md:p-5 text-center">
                      ...
                      <button onClick={async () => {
                          ...
                          if (value) { console.log("recieved response " , value); setRefreshServerAndRoomData(c => c + 1); setShowSpinner(false); setMessage(value); setTimeout(() => {setMessage(null) ; setShowMoreOptions({show: false})} , 2000)};
  ...
  : (
    ...
    <section className="float-left absolute w-[230px]" style={{top : `${Number(y -20)}px` , left : `${Number(x) + 40}px`}}>
              
        <section className="w-[100%] float-left absolute z-[2]"  >
          <section className="text-white p-[15px] border-b rounded bg-[#12151D] border-b-[#1D202F] hover:bg-[#1D202F] hover:cursor-pointer">Edit Message</section>
          <section className="text-white p-[15px]  bg-[#ff5b00]  hover:bg-[#991B1B] rounded hover:cursor-pointer border-b border-b-[#1D202F] "
          onClick={() => {
            setShowConfirmation(true);
          }} >Delete Message</section>
          <section onClick={() => {setShowMoreOptions({show: false})}} className="text-white p-[15px] bg-[#D32529]  hover:bg-[#991B1B] rounded  hover:cursor-pointer ">Cancel</section>
        </section>
    </section>
    )
